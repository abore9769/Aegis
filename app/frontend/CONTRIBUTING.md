# Contributing to Aegis Frontend

Thank you for your interest in contributing to the Aegis frontend! This document covers the development workflow, code standards, and conventions for submitting changes.
...
- **Questions**: Open a [GitHub Discussion](https://github.com/your-org/aegis/discussions)
- **Bugs**: Open a [GitHub Issue](https://github.com/your-org/aegis/issues) with steps to reproduce
