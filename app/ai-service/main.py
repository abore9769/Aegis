"""
Aegis AI Service - FastAPI Application
...
async def lifespan(app: FastAPI):
    logger.info("Starting up Aegis AI Service...")
    ...
    yield
    logger.info("Shutting down Aegis AI Service...")


app = FastAPI(
    title="Aegis AI Service",
    description="AI service layer for Aegis platform using FastAPI",
    version="1.0.0",
    lifespan=lifespan,
)
...
async def health_check():
    return {"status": "healthy", "service": "aegis-ai-service", "version": "1.0.0"}
