...
const VERSION_CONFIG_URL = 'https://api.pulsefy.org/aegis/mobile/version';
  ...
  try {
    ...
    */
    ...
    return {
      ...
      storeUrl: {
        ios: 'https://apps.apple.com/app/aegis',
        android: 'https://play.google.com/store/apps/details?id=org.pulsefy.aegis.mobile',
      },
    };
  } catch (error) {
