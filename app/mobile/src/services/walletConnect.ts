...
const APP_SCHEME = 'aegis';
const DEFAULT_APP_URL = 'https://github.com/Pulsefy/Aegis';
const DEFAULT_ICON = 'https://raw.githubusercontent.com/Pulsefy/Aegis/main/app/mobile/assets/icon.png';
...
const getAppMetadata = () => ({
  name: 'Aegis Mobile',
  description: 'Aegis mobile wallet connection for transparent aid delivery on Stellar.',
  url: DEFAULT_APP_URL,
  icons: [DEFAULT_ICON],
  redirect: {
